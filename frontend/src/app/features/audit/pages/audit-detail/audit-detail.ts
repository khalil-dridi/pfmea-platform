...
import { HistoryComparison } from '../../components/history-comparison/history-comparison';
import { AuditLog } from '../../models/audit-log.model';
import { AuditService } from '../../services/audit.service';
import { toHistoryEventView } from '../../utils/audit-history.utils';
import { resolveAuditApiError } from '../../utils/audit.utils';

@Component({
  selector: 'app-audit-detail',
  imports: [RouterLink, HistoryComparison],
...
export class AuditDetail implements OnInit {
  ...
  readonly item = computed(() => {
    const log = this.log();
    return log ? toHistoryEventView(log) : null;
  });
